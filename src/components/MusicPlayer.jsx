  ...
  return (
    <div className="musicPlayer flex flex-col px-5 w-[100%] border-2 border-black py-3 bg-[#232A4E] rounded-xl mt-5">
        ...
        <div className="upperSection flex items-center justify-between">
            <div className="profile flex">
                ...
                <div className="details flex flex-col ml-4">
                    <span className='text-[1rem]'>Aspiration</span>
                    <span className='text-sm text-gray-500'>Yinka Ayefele</span>
                </div>
            </div>
            <div>
        ...
        <div className="lowerSection">
            <div className="track flex flex-[2] justify-between items-center text-sm text-gray-400">
                <span>6: 10</span>
            ...
            <div className="controllers flex flex-1 items-center justify-around">
